const initialState = {
    ...
    categoryItems: {
        Brus: {
            ...
            footer:
                'Непрофессионалу в строительной области достаточно сложно разобраться с таким разнообразием размеров бруса: если у вас возникли вопросы, какой брус нужен именно вам, или вам сложно рассчитать необходимое количество кубов, достаточно позвонить по телефону +7 (922) 215-61-03 или воспользоваться формой обратной связи.',
            items: [
                '100x100',
                '100x150',
                '150x150',
        ...
        Brusok: {
            ...
            footer:
                'Позвоните нам по тел. +7 (922) 215-61-03, и мы посоветуем, какой брусок подходит под ваши нужды, а также рассчитаем необходимое количество кубов.', // todo
        ...
        Neobrabotannaya_doska: {
            ...
            footer:
                'Позвоните нам по тел. +7 (922) 215-61-03, и мы посоветуем, какая необрезная подходит под ваши нужды, а также рассчитаем необходимое количество кубов.',
            items: [
        ...
        Obreznaya_doska: {
            ...
            footer:
                'Количество досок в одном кубе отличается от толщины пиломатериала: чем тоньше доска, тем больше единиц содержит куб. Рассчитать необходимое количество обрезной доски для ваших нужд поможет наш менеджер по телефону +7 (922) 215-61-03.',
            items: [
    ...
    items: {
        '100x100': {
            ...
            Characteristic: '100 x 150, естественной влажности',
        ...
        '100x150': {
            ...
            Characteristic: '100 x 100, естественной влажности',
        ...
        '150x150': {
            ...
            Characteristic: '150 x 150, естественной влажности',
        ...
        '100x200': {
            ...
            Characteristic: '100 x 200, естественной влажности',
        ...
        '150x200': {
            ...
            Characteristic: '150 x 200, естественной влажности',
            img: '/img/catalog/Брус/brus-150x200.jpg',
            URL: '/product/150x200',
            description: [
        ...
        '200x200': {
            ...
            Characteristic: '200 x 200, естественной влажности',
        ...
        '50x50-3m': {
            ...
            description: ['Применение в строительстве'],
        },
        '50x50-6m': {
        ...
        '50x70': {
            ...
            URL: '/product/50x70',
            description: ['лага'], // todo описать про лаги
        },
        'neobreznaya-doska-25': {
